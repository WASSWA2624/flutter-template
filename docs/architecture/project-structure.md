...
`shared/data` and feature-neutral search helpers in `shared/search`. Platform
folders are generated by Flutter and should stay limited to host-specific
runner code and configuration.
